...
public class JuegoNivel3 implements Screen {
	...
	public JuegoNivel3(final KillBoss juego, int puntaje, int vidas) {
		this.juego = juego;
	...
	public void render(float delta) {	
        ...
        if (this.numeroPreguntas > 0 && this.vidas > 0) {
           ...
           if (this.zackDerechaR.overlaps(BR) && this.azar % 2 != 0) {
        	...
        	if (this.numeroPreguntas == 0 && this.vidas > 0) {
        		this.juego.setScreen(new GanastePiernas(this.juego, this.puntaje, this.vidas));
    			this.dispose();    			
        	}
        	else {
