...
public class ZackGana implements Screen {
	 ...
	 * Método constructor
	 */
	public ZackGana(final KillBoss juego, int puntaje, int vidas) {
		this.juego = juego;
		this.puntaje = puntaje;
		this.vidas = vidas;
		
		// Cargo la imagen de fondo
		this.fondoImg = new Texture(Gdx.files.internal("zackGana.png"));
