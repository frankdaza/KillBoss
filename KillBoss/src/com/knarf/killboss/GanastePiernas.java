...
public class GanastePiernas implements Screen {
	 ...
	 * Método constructor
	 */
	public GanastePiernas(final KillBoss juego, int puntaje){
		this.juego = juego;
	...
	public void render(float delta) {
		...
		if (Gdx.input.isKeyPressed(Keys.ANY_KEY)) {
			this.juego.setScreen(new Mapa4(this.juego, this.puntaje));
			this.dispose();
		}
