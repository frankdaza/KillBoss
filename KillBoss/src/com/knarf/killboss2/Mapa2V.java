...
public class Mapa2V implements Screen {
	...
	public Mapa2V(final KillBoss juego, int puntaje, int vidas) {		
		this.juego = juego;
	...
	public void render(float delta) {
       ...
       if ( (this.valentinaR.overlaps(this.armaduraManosR)) || (this.valentinaDerechaR.overlaps(this.armaduraManosR)) ) {
    	   this.juego.setScreen(new Nivel2V(this.juego, this.puntaje, this.vidas));
    	   this.dispose();
       }
       ...
       if (Gdx.input.isKeyPressed(Keys.F1)) {
    	   GuardarPartida partida = new GuardarPartida(this.juego, this.puntaje, 2, 2);
    	   partida.inicio();
       }
