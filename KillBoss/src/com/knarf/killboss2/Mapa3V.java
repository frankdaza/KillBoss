...
public class Mapa3V implements Screen {
	...
	public Mapa3V(final KillBoss juego, int puntaje, int vidas) {		
		this.juego = juego;
	...
	public void render(float delta) {
       ...
       if ( (this.valentinaR.overlaps(this.armaduraPiernasR)) || (this.valentinaDerechaR.overlaps(this.armaduraPiernasR)) ) {
    	   this.juego.setScreen(new Nivel3V(this.juego, this.puntaje, this.vidas));
    	   this.dispose();
       }
