...
public class JuegoNivel4V implements Screen {
	...
	public JuegoNivel4V(final KillBoss juego, int puntaje, int vidas) {
		this.juego = juego;
	...
	public void render(float delta) {	
		...
		this.juego.texto.draw(this.juego.batch, "Nivel 4 - Programación en Java", 2048 / 2 - 500, 1010);
        ...
        if (this.numeroPreguntas > 0 && this.vidas > 0) {
           ...
           if (this.valentinaDerechaR.overlaps(BR) && this.azar % 2 != 0) {
        	...
        	if (this.numeroPreguntas == 0 && this.vidas > 0) {
        		this.juego.setScreen(new GanasteCascoV(this.juego, this.puntaje, this.vidas));
    			this.dispose();    			
        	}
        	else {
