...
public class Nivel2V implements Screen {
	 ...
	 * Método constructor
	 */
	public Nivel2V(final KillBoss juego, int puntaje, int vidas) {
		this.juego = juego;
	...
	public void render(float delta) {
		...
		if (Gdx.input.isKeyPressed(Keys.ENTER)) {
			this.juego.setScreen(new JuegoNivel2V(this.juego, this.puntaje, this.vidas));
			this.dispose();
		}
	}
