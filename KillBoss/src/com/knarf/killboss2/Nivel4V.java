...
public class Nivel4V implements Screen {
	 ...
	 * Método constructor
	 */
	public Nivel4V(final KillBoss juego, int puntaje, int vidas) {
		this.juego = juego;
		this.puntaje = puntaje;
		this.vidas = vidas;
		
		// Cargo la imagen de fondo
		this.fondoImg = new Texture(Gdx.files.internal("nivel4.png"));
	...
	public void render(float delta) {
		...
		if (Gdx.input.isKeyPressed(Keys.ENTER)) {
			this.juego.setScreen(new JuegoNivel4V(this.juego, this.puntaje, this.vidas));
			this.dispose();
		}		
	}
