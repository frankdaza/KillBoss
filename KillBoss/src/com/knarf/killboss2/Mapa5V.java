...
public class Mapa5V implements Screen {
	...
	public Mapa5V(final KillBoss juego, int puntaje, int vidas) {		
		this.juego = juego;
		...
		this.valentinaNormal = new Texture(Gdx.files.internal("valentinaCasco.png"));					
	...
	public void render(float delta) {
       ...
       if ( (this.valentinaR.overlaps(this.escudoR)) || (this.valentinaDerechaR.overlaps(this.escudoR)) ) {
    	   this.juego.setScreen(new Nivel5V(this.juego, this.puntaje, this.vidas));
    	   this.dispose();
       }
       ...
       if (Gdx.input.isKeyPressed(Keys.F1)) {
    	   GuardarPartida partida = new GuardarPartida(this.juego, this.puntaje, 5, 2);
    	   partida.inicio();
       }
