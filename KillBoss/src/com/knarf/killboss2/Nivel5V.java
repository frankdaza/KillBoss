...
public class Nivel5V implements Screen {
	 ...
	 * Método constructor
	 */
	public Nivel5V(final KillBoss juego, int puntaje, int vidas) {
		this.juego = juego;
	...
	public void render(float delta) {
		...
		if (Gdx.input.isKeyPressed(Keys.ENTER)) {
			this.juego.setScreen(new JuegoNivel5V(this.juego, this.puntaje, this.vidas));
			this.dispose();
		}
	}
