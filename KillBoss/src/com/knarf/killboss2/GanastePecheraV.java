...
public class GanastePecheraV implements Screen {
	 ...
	 * Método constructor
	 */
	public GanastePecheraV(final KillBoss juego, int puntaje, int vidas){
		this.juego = juego;
	...
	public void render(float delta) {
		...
		if (Gdx.input.isKeyPressed(Keys.ENTER)) {
			this.juego.setScreen(new Mapa2V(this.juego, this.puntaje, this.vidas));
			this.dispose();
		}			
	}	
