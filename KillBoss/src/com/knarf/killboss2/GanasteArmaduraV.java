...
public class GanasteArmaduraV implements Screen {
	 ...
	 * Método constructor
	 */
	public GanasteArmaduraV(final KillBoss juego, int puntaje, int vidas) {
		this.juego = juego;
	...
	public void render(float delta) {
		...
		if (Gdx.input.isKeyPressed(Keys.ENTER)) {
			this.juego.setScreen(new Mapa7V(this.juego, this.puntaje, this.vidas));
			this.dispose();
		}				
	}	
