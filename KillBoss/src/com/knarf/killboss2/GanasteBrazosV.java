...
public class GanasteBrazosV implements Screen {
	 ...
	 * Método constructor
	 */
	public GanasteBrazosV(final KillBoss juego, int puntaje, int vidas) {
		this.juego = juego;
		this.puntaje = puntaje;
		this.vidas = vidas;
		
		// Cargo la imagen de fondo
		this.fondoImg = new Texture(Gdx.files.internal("ganasteBrazos.png"));
	...
	public void render(float delta) {
		...
		if (Gdx.input.isKeyPressed(Keys.ENTER)) {
			this.juego.setScreen(new Mapa3V(this.juego, this.puntaje, this.vidas));
			this.dispose();
		}			
	}
