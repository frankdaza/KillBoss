...
public class GanasteCascoV implements Screen {
	 ...
	 * Método constructor
	 */
	public GanasteCascoV(final KillBoss juego, int puntaje, int vidas) {
		this.juego = juego;
	...
	public void render(float delta) {
		...
		if (Gdx.input.isKeyPressed(Keys.ENTER)) {
			this.juego.setScreen(new Mapa5V(this.juego, this.puntaje, this.vidas));
			this.dispose();
		}				
	}
