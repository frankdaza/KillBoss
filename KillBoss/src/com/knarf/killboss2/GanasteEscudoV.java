...
public class GanasteEscudoV implements Screen {
	 ...
	 * Método constructor
	 */
	public GanasteEscudoV(final KillBoss juego, int puntaje, int vidas) {
		this.juego = juego;
	...
	public void render(float delta) {
		...
		if (Gdx.input.isKeyPressed(Keys.ENTER)) {
			this.juego.setScreen(new Mapa6V(this.juego, this.puntaje, this.vidas));
			this.dispose();
		}				
	}	
