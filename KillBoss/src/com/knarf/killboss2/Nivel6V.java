...
public class Nivel6V implements Screen {
	 ...
	 * Método constructor
	 */
	public Nivel6V(final KillBoss juego, int puntaje, int vidas) {
		this.juego = juego;
	...
	public void render(float delta) {
		...
		if (Gdx.input.isKeyPressed(Keys.ENTER)) {
			this.juego.setScreen(new JuegoNivel6V(this.juego, this.puntaje, this.vidas));
			this.dispose();
		}
	}
