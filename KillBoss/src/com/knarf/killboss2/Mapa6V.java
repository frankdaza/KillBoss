...
public class Mapa6V implements Screen {
	...
	public Mapa6V(final KillBoss juego, int puntaje, int vidas) {		
		this.juego = juego;
	...
	public void render(float delta) {
       ...
       if ( (this.valentinaR.overlaps(this.espadaR)) || (this.valentinaDerechaR.overlaps(this.espadaR)) ) {
    	   this.juego.setScreen(new Nivel6V(this.juego, this.puntaje, this.vidas));
    	   this.dispose();
       }
