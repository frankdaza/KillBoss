...
public class JuegoNivel5V implements Screen {
	...
	public JuegoNivel5V(final KillBoss juego, int puntaje, int vidas) {
		this.juego = juego;
	...
	public void render(float delta) {	
        ...
        if (this.numeroPreguntas > 0 && this.vidas > 0) {
           ...
           if (this.valentinaDerechaR.overlaps(BR) && this.azar % 2 != 0) {
        	...
        	if (this.numeroPreguntas == 0 && this.vidas > 0) {
        		this.juego.setScreen(new GanasteEscudoV(this.juego, this.puntaje, this.vidas));
    			this.dispose();    			
        	}
        	else {
