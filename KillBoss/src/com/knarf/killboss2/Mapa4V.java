...
public class Mapa4V implements Screen {
	...
	public Mapa4V(final KillBoss juego, int puntaje, int vidas) {		
		this.juego = juego;
		this.puntaje = puntaje;
		this.vidas = vidas;
		
		// Configuro el sprite de valentinaDerecha
		this.walkSheetDerecha = new Texture(Gdx.files.internal("sprites/valentinaSpritePiernasD.png"));
		...
		this.walkSheetIzquierda = new Texture(Gdx.files.internal("sprites/valentinaSpritePiernasI.png"));
		...
		this.valentinaNormal = new Texture(Gdx.files.internal("valentinaPiernas.png"));					
	...
	public void render(float delta) {
       ...
       if ( (this.valentinaR.overlaps(this.cascoR)) || (this.valentinaDerechaR.overlaps(this.cascoR)) ) {
    	   this.juego.setScreen(new Nivel4V(this.juego, this.puntaje, this.vidas));
    	   this.dispose();
       }
       ...
       if (Gdx.input.isKeyPressed(Keys.F1)) {
    	   GuardarPartida partida = new GuardarPartida(this.juego, this.puntaje, 4, 2);
    	   partida.inicio();
       }
